...
# add wave -color {yellow} /tb_sync_fifo/xpm_almost_full

# add wave -divider {almost_empty}

# add wave /tb_sync_fifo/almost_empty
# add wave -color {yellow} /tb_sync_fifo/xpm_almost_empty

# add wave -divider {prog_full}

# add wave /tb_sync_fifo/prog_full
# add wave -color {yellow} /tb_sync_fifo/xpm_prog_full

# add wave -divider {prog_empty}

# add wave /tb_sync_fifo/prog_empty
# add wave -color {yellow} /tb_sync_fifo/xpm_prog_empty

# add wave -divider {overflow}

# add wave /tb_sync_fifo/overflow
# add wave -color {yellow} /tb_sync_fifo/xpm_overflow

# add wave -divider {underflow}

# add wave /tb_sync_fifo/underflow
# add wave -color {yellow} /tb_sync_fifo/xpm_underflow
